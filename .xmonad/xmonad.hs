...
-- Borders.
-- <http://xmonad.org/xmonad-docs/xmonad-contrib/XMonad-Actions-NoBorders.html>.
...
-- <http://haskell.org/haskellwiki/Xmonad/Frequently_asked_questions#dzen_status_bars>,
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    --
    -- Danil.
    -- Alt-[F1..F12], Switch to workspace N.
...
myLogHook = return ()
-- -- Danil.
-- -- <http://haskell.org/pipermail/xmonad/2009-September/008658.html>.
